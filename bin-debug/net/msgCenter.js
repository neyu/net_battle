...
var MsgCenter = (function () {
     ...
     */
    function MsgCenter(type) {
        this.type = type;
        this.dict = {};
        this.eVec = new Array();
        this.lastRunTime = 0;
        if (this.type == 0) {
            TimerMgr.inst.doFrame(1, 0, this.run, this);
        }
    }
    Object.defineProperty(MsgCenter, "inst", {
        get: function () {
            if (MsgCenter._inst == null) {
                MsgCenter._inst = new MsgCenter(0);
            }
            return MsgCenter._inst;
        },
        enumerable: true,
        configurable: true
    });
     ...
     * 清空处理
     */
    MsgCenter.prototype.clear = function () {
        this.dict = {};
        this.eVec.splice(0);
    };
    /**
     ...
     *
     */
    MsgCenter.prototype.addListener = function (type, listener, listenerObj) {
     ...
     * @param listenerObj 侦听函数所属对象
     */
    MsgCenter.prototype.removeListener = function (type, listener, listenerObj) {
        var arr = this.dict[type];
        if (arr == null) {
            return;
        }
     ...
     * @param listenerObj 侦听函数所属对象
     */
    MsgCenter.prototype.removeAll = function (listenerObj) {
     ...
     *
     */
    MsgCenter.prototype.dispatch = function (type) {
        var param = [];
        ...
        if (this.type == 0) {
            ...
            console.log("[Warn]:MessageCenter未实现的类型");
        }
    };
    /**
     * 运行
     *
     */
    MsgCenter.prototype.run = function () {
     ...
     * @param msgVo
     */
    MsgCenter.prototype.dealMsg = function (msgVo) {
